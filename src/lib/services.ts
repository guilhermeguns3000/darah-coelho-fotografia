...
export const services: Service[] = [
  ...
  },
  {
    ...
    title: "Fotos de Produtos para Loja e E-commerce",
    shortTitle: "Fotos de Produtos",
    headline: "Fotos de produtos que vendem — para loja de roupa, e-commerce e catálogo",
    description:
      "Fotografia de produtos para lojas de roupa, e-commerce e catálogo, feita por quem entende de moda. Fundo branco no padrão do marketplace, manequim fantasma e foto com modelo. Produtos de todo o Brasil chegam por transportadora.",
    bodyText: [
      "No e-commerce a foto é o produto. O cliente não toca no tecido, não veste, não sente o caimento: ele decide olhando uma imagem. Foto mal iluminada, cor que não bate com a peça real e fundo sujo derrubam a conversão e enchem a loja de troca e devolução. Foto boa faz o contrário — vende mais, devolve menos e ainda sustenta o preço que a peça merece.",
      "A Darah Coelho fotografa produtos para lojas de roupa, marcas de moda, e-commerces e atacados, com a vantagem de vir da fotografia de moda: ela não trata a peça como uma caixa em cima da mesa. Sabe montar o look, ajustar o caimento, escolher o acessório que valoriza, dirigir a modelo e fazer a roupa parecer o que ela é de verdade. É a diferença entre uma foto que registra a peça e uma foto que dá vontade de comprar.",
      "São três formatos, combináveis no mesmo pedido. O fundo branco infinito é o padrão que Shopee, Mercado Livre, Amazon e Shein exigem, e o que padroniza a vitrine da sua loja. O manequim fantasma mostra a peça com volume e corpo, mas sem manequim visível — é o formato preferido de quem vende roupa online, porque revela o caimento sem custo de modelo. E a foto com modelo serve para campanha, lookbook e o conteúdo que alimenta o Instagram da loja.",
      "Para quem tem muitos itens, o trabalho é por volume: preço por peça, prazo fechado e padrão visual idêntico do primeiro ao último produto — o que importa quando a vitrine tem centenas de SKUs e nenhum pode destoar. Atendemos Goiânia e região presencialmente, e o Brasil inteiro por transportadora: você envia as peças, recebe as fotos prontas e o material de volta.",
    ],
    metaTitle: "Fotos de Produtos para E-commerce e Catálogo | Darah Coelho",
    metaDescription:
      "Fotos de produtos para loja de roupa e e-commerce: fundo branco, manequim fantasma e foto com modelo. Feito por fotógrafa de moda. Envie suas peças e receba as fotos prontas.",
    keywords: [
      "fotos de produtos",
      "fotografia de produto",
      "fotos de produtos para e-commerce",
      "fotografia de roupas para loja virtual",
      "fotos para catálogo de roupas",
    ],
    ...
    deliverables: [
      "Fundo branco infinito no padrão de cada marketplace",
      "Manequim fantasma — caimento sem custo de modelo",
      "Foto com modelo para campanha, lookbook e Instagram",
      "Múltiplos ângulos e detalhes de tecido, costura e etiqueta",
      "Pós-produção completa: recorte, cor fiel à peça e padronização",
      "Preço por peça e prazo fechado para catálogos grandes",
    ],
    process: [
      { step: "Briefing", description: "Quantas peças, para qual canal (marketplace, site próprio, catálogo, Instagram) e qual o estilo da sua marca." },
      { step: "Envio das peças", description: "Você entrega em Goiânia ou manda por transportadora de qualquer lugar do Brasil. As peças voltam junto com as fotos." },
      { step: "Produção", description: "Sessão em estúdio com iluminação controlada, no formato combinado: fundo branco, manequim fantasma, modelo ou os três." },
      { step: "Entrega", description: "Arquivos tratados e padronizados, no tamanho e formato certos para publicar direto, sem retrabalho." },
    ],
    faqs: [
      { question: "Como fotografar roupas para vender online?", answer: "O básico é iluminação uniforme, fundo limpo, cor fiel à peça real e padrão igual em todos os itens. O que separa uma foto que vende de uma que só registra é o caimento: a peça precisa parecer vestida, com volume e forma. É por isso que manequim fantasma e foto com modelo convertem mais que a peça esticada na mesa — e é esse trabalho que a Darah faz." },
      { question: "O que é manequim fantasma?", answer: "É a técnica em que a roupa aparece com corpo e caimento, mas o manequim é removido na edição. O cliente vê como a peça veste sem você pagar modelo em cada item. É o formato mais usado por loja de roupa online porque une o padrão do marketplace com a noção real de forma." },
      { question: "Vocês atendem loja de fora de Goiânia?", answer: "Sim, o Brasil inteiro. As peças chegam por transportadora ou Correios, são fotografadas e voltam junto com a entrega das imagens. Para catálogos grandes combinamos a logística antes de começar." },
      { question: "Quanto custa fotografar um catálogo inteiro?", answer: "O cálculo é por peça, e o valor cai conforme o volume. Mande a quantidade de itens e o formato que você precisa (fundo branco, manequim fantasma, com modelo) para receber um orçamento fechado, com prazo." },
      { question: "As fotos saem prontas para o marketplace?", answer: "Sim. Entregamos nas especificações de Shopee, Mercado Livre, Amazon, Shein e das principais plataformas de loja virtual, além dos formatos para Instagram e para o site próprio." },
      { question: "Dá para fotografar a coleção inteira com modelo?", answer: "Sim. É o formato de campanha e lookbook: a Darah cuida da direção, do styling e da escolha do estúdio, e entrega tanto as fotos de catálogo quanto o material de divulgação da coleção." },
    ],
    schemaType: "Photographer",
