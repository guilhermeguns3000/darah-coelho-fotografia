...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Fotografia de casamento em Goiânia com olhar documental e estética editorial. Cada detalhe, cada emoção, cada momento único do seu dia registrado com verdade e arte.",
    bodyText: [
    ...
    metaTitle: "Fotógrafa Casamento Goiânia | Darah Coelho Fotografia",
    metaDescription:
      "Fotógrafa de casamento em Goiânia com estética editorial e olhar documental. Darah Coelho registra cada emoção do seu dia com verdade e arte. Consulte disponibilidade.",
    keywords: [
      "fotógrafa casamento Goiânia",
      "fotografia casamento Goiânia",
      "fotógrafa de casamento Goiânia",
      "casamento Goiânia fotógrafa",
      "melhor fotógrafa casamento Goiânia",
    ],
    heroImage: "https://images.unsplash.com/photo-1519741347686-c1e0aadf4611?w=1920&q=80",
    deliverables: [
  ...
  },
  {
    ...
    metaDescription:
      "Ensaio fotográfico de gestante em Goiânia com leveza e elegância. Fotógrafa Darah Coelho — sessões em estúdio ou externas. Registre esse momento único. Agende.",
    keywords: [
  ...
  },
  {
    ...
    shortTitle: "Newborn",
    headline: "Ensaio newborn em Goiânia nos primeiros dias de vida do seu bebê",
    description:
      "Ensaio fotográfico newborn em Goiânia com segurança, delicadeza e arte. Cada detalhe do seu recém-nascido registrado nos primeiros 14 dias de vida, quando são pequeninos e dormentes.",
    bodyText: [
      "O ensaio newborn em Goiânia captura o que a memória não consegue guardar sozinha: os dedinhos minúsculos, o bochechão macio, o jeito de dormir enrolado que parece impossível. Nos primeiros dias de vida, os bebês ainda têm aquela flexibilidade e sonolência profunda que permitem poses delicadas e imagens de tirar o fôlego. A janela ideal é curta — entre o 5º e 14º dia — por isso o agendamento durante a gravidez é essencial.",
      "O ensaio newborn realizado pela Darah Coelho em Goiânia é conduzido com segurança absoluta como prioridade número um. Nenhuma pose é feita de forma que coloque o bebê em risco. O estúdio tem temperatura controlada, cenários montados com materiais seguros e o ritmo da sessão é sempre ditado pelo bebê — com pausas para amamentação, troca e acalmar quando necessário. Os pais ficam presentes o tempo todo.",
      "O resultado são imagens que você vai querer imprimir em tamanho grande e guardar para sempre. O ensaio newborn em Goiânia inclui os pais e irmãos, wraps, cestinhos, flores e todos os props necessários. Você vem apenas com o bebê — e a Darah cuida do resto com o cuidado e a arte que esse momento tão único merece.",
    ],
    metaTitle: "Ensaio Newborn Goiânia | Fotógrafa Darah Coelho",
    metaDescription:
      "Ensaio newborn em Goiânia com segurança e delicadeza. Fotógrafa Darah Coelho registra os primeiros dias do seu bebê. Agende ainda na gravidez para garantir a data.",
    keywords: [
    ...
    deliverables: [
      ...
      "Poses newborn com segurança garantida",
      "Opção de incluir pais e irmãos",
      "Edição delicada e entrega em alta resolução",
      "Álbum digital para compartilhar com a família",
    ],
    process: [
      { step: "Agendamento", description: "Agende ainda durante a gravidez — as datas para os primeiros dias após o nascimento são limitadas." },
      { step: "Aviso do nascimento", description: "Ao nascer, você nos avisa e confirmamos a data da sessão dentro da janela ideal." },
      { step: "Sessão", description: "Sessão no estúdio com temperatura controlada, no ritmo do bebê — pausas para amamentação e troca." },
      { step: "Entrega", description: "Fotos editadas com suavidade e entregues em galeria online em até 20 dias úteis." },
    ],
    faqs: [
      { question: "Até quantos dias de vida posso fazer o ensaio newborn?", answer: "O ideal é entre o 5º e 14º dia de vida. Nessa fase os bebês dormem mais profundamente, ficam mais flexíveis para as poses e a experiência é muito mais tranquila para todos." },
      { question: "O ensaio newborn é seguro?", answer: "Sim. Todas as poses são executadas com segurança total. Nunca coloco o bebê em risco por uma foto. As poses de segurança são a prioridade absoluta." },
      { question: "Como devo agendar se não sei a data do nascimento?", answer: "Agende ainda durante a gestação. Quando o bebê nascer, você nos avisa e confirmamos a data dentro da janela ideal. Trabalhamos com flexibilidade para acomodar o nascimento." },
      { question: "Preciso levar algo para o ensaio?", answer: "Temos todos os cenários, wraps e props necessários. Você precisa apenas vir com o bebê e, se quiser, alguma peça especial de família (manta, ursinho, sapatinhos)." },
    ],
    schemaType: "Photographer",
    color: "from-sky-950 to-stone-900",
  },
  {
