...
export const services: Service[] = [
  ...
  },
  {
    ...
    bodyText: [
      ...
      "Para quem prefere o ensaio de gestante externo em Goiânia, a cidade oferece cenários lindos de luz natural: o Parque Vaca Brava e o Parque Flamboyant, no Jardim Goiás, o Bosque dos Buritis e o Jardim Botânico trazem verde, água e o fim de tarde dourado que combinam com a delicadeza da gravidez. Muitas mães também já agendam o ensaio newborn do bebê na sequência, garantindo o mesmo olhar autoral no antes e no depois. O investimento varia conforme a duração e o pacote escolhido, e o orçamento é feito sob medida para o seu momento.",
    ],
    ...
    faqs: [
      ...
      { question: "Dá para combinar o ensaio de gestante com o newborn do bebê?", answer: "Sim, e é uma escolha linda. Muitas mães fecham o ensaio de gestante e já agendam o newborn para os primeiros dias do bebê, garantindo o mesmo olhar autoral no antes e no depois. Consulte os pacotes combinados." },
    ],
    schemaType: "Photographer",
